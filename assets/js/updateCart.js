document.addEventListener('DOMContentLoaded', () => {
    ...
    const adjustQuantity = async (event) => {
        ...
        try {
            const response = await fetch('http://localhost/methode%20MVC/MVC%20PROJET/E-Shop/E-Commerce-MVC/?action=adjustQuantity', {
                method: 'POST',
                headers: {
    ...
    const removeFromCart = async (event) => {
        ...
        try {
            const response = await fetch('http://localhost/methode%20MVC/MVC%20PROJET/E-Shop/E-Commerce-MVC/?action=removeFromCart', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                },
