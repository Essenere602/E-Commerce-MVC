...
class ValidationModel {
    ...
    public function prepareOrder() {
        ...
        try {
            ...
            $pdo = $this->db->getConnection()->prepare('INSERT INTO user_order_detail SET order_id = ?, product_id = ?, product_option_id = 0, product_option_value = 0, price_exc_vat = ?, vat = ?, vat_amount = ?');
            $pdo->execute($_SESSION['order_id'], $productId, $priceExcVat, $vat, $vatAmount);
